...
it
*/
describe('ADF.GridView', function() {
    var MOCK_GET_DATA = {
        author: 'Ken Tabor',
    ...
    it('should empty it\'s collection when it receives an empty records array after receiving a non-empty records array in a previous call', function() {
        var adf = new ADF.App({container: 'body'});
        adf.page = new ADF.PageLayoutView({el:'.adf-page'});
        var gridView = new ADF.GridView({
